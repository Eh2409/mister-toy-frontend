...
import { userService } from './user/index-user.js'
...
export const SOCKET_EMIT_USER_TYPING = 'emit-user-typing'
export const SOCKET_EVENT_USER_TYPING = 'event-user-typing'
